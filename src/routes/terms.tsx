...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Conditions d'utilisation — AgroField" },
      { name: "description", content: "Conditions générales d'utilisation d'AgroField." },
    ],
  }),
  component: TermsPage,
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <Link to="/" className="mb-6 inline-flex items-center gap-2 text-primary">
        <Leaf className="h-5 w-5" /> <span className="font-bold">AgroField</span>
      </Link>
      ...
      <section className="space-y-4 text-sm">
        <p><strong>Service.</strong> AgroField est une application de gestion agricole destinée aux exploitants d'Afrique de l'Ouest.</p>
        <p><strong>Compte.</strong> Tu es responsable de la confidentialité de ton mot de passe et de tes accès Google.</p>
        <p><strong>Contenu.</strong> Tu restes propriétaire de tes données. Tu accordes à AgroField le droit de les traiter uniquement pour te fournir le service.</p>
        ...
        <p><strong>Responsabilité.</strong> AgroField ne peut être tenu responsable des pertes de récolte, décisions financières ou dommages liés à l'usage de l'app.</p>
