...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Politique de confidentialité — AgroField" },
      { name: "description", content: "Comment AgroField collecte, utilise et protège tes données agricoles." },
    ],
  }),
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <section className="prose prose-sm max-w-none space-y-4">
        ...
        <p>AgroField collecte : email, nom, parcelles (géolocalisation, cultures), dépenses/ventes, photos de plantes, mesures de capteurs.</p>
