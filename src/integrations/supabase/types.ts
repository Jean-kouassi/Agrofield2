  ...
  public: {
    Tables: {
      ...
      crop_events: {
        Row: {
          ...
          event_type: string
          id: string
          input_cost_fcfa: number | null
          labor_cost_fcfa: number | null
          notes: string | null
          parcel_id: string
          user_id: string
      ...
      user_finances: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_finances_parcel_id_fkey"
            columns: ["parcel_id"]
            isOneToOne: false
            referencedRelation: "parcels"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_or_create_conversation: {
        Args: { p_participant_2_id: string; p_listing_id?: string | null }
        Returns: string
      }
